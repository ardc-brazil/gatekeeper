...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['dataset_id'], ['datasets.id'], name='dataset_file_dataset_id_fkey'),
    sa.ForeignKeyConstraint(['file_id'], ['data_files.id'], name='dataset_file_file_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['dataset_id'], ['datasets.id'], name='dataset_version_dataset_id_fkey'),
    sa.ForeignKeyConstraint(['version_id'], ['dataset_versions.id'], name='dataset_version_version_id_fkey'),
    sa.PrimaryKeyConstraint('dataset_id', 'version_id', name='dataset_version_pkey')
    )
    # ### end Alembic commands ###
