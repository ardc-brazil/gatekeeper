...
def upgrade() -> None:
    ...
    op.add_column('dataset_versions', sa.Column('doi_identifier', sa.String(length=256), nullable=True))
    op.add_column('dataset_versions', sa.Column('doi_state', sa.String(length=256), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('dataset_versions', sa.Column('zip_id', postgresql.UUID(), autoincrement=False, nullable=True))
