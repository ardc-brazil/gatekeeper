...
tenancy_model = namespace.model('Tenancy', {
    ...
    'updated_at': fields.String(required=True, description='Tenancy last update date')
})

tenancy_create_request_model = namespace.model('TenancyCreateRequest', {
    'name': fields.String(required=True, description='Tenancy name'),
})

tenancy_update_request_model = namespace.model('TenancyUpdateRequest', {
    'name': fields.String(required=True, description='Tenancy name'),
    'is_enabled': fields.Boolean(required=True, description='Is tennacy enabled?')
})
