...
class Test_Secret(unittest.TestCase):
    def test_hash_password(self):
        ...
        self.assertTrue(
            isinstance(hashed_password, str), "Hashed password should be a string"
        )
        self.assertNotEqual(
            password,
            hashed_password,
    ...
    def test_hash_uniqueness(self):
        ...
        self.assertNotEqual(
            hashed_password1,
            hashed_password2,
            "Each hash of the same password should be unique",
        )
    ...
    def test_check_password_with_different_hash(self):
        ...
        self.assertFalse(
            check_password(password, hashed_other_password),
            "check_password should return False when the hash is for a different password",
        )
