...
class TestUserService(unittest.TestCase):
    ...
    def test_fetch_by_id_success(self):
        ...
        self.user_repository.fetch_by_id.assert_called_once_with(id=user_id, is_enabled=True)
    ...
    def test_fetch_by_provider_not_found(self):
        ...
        self.assertEqual(str(context.exception), f"not_found: {provider_name} {reference}")
        self.user_repository.fetch_by_provider.assert_called_once_with(
            provider_name=provider_name, reference=reference, is_enabled=True
        )
    ...
    def test_update_success(self):
        ...
        self.user_service.update(user_id, name="Updated Name", email="updated@example.com")
    ...
    def test_add_roles_success(self):
        ...
        for role in roles:
            self.casbin_enforcer.add_role_for_user.assert_any_call(user=user_id, role=role)
        self.user_repository.fetch_by_id.assert_called_once_with(id=user_id)
    ...
    def test_remove_roles_success(self):
        ...
        for role in roles:
            self.casbin_enforcer.delete_role_for_user.assert_any_call(user=user_id, role=role)
        self.user_repository.fetch_by_id.assert_called_once_with(id=user_id)
