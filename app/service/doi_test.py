...
from app.model.doi import DOI, Mode, State, Event, Title as TitleModel, Creator as CreatorModel
...
class TestDOIService(unittest.TestCase):
    ...
    def test_validate_manual_doi_valid(self):
        ...
        try:
            ...
            self.fail("_validate_manual_doi() levantou BadRequestException inesperadamente!")
    ...
    def test_validate_auto_doi_valid(self):
        ...
        try:
            ...
            self.fail("_validate_auto_doi() levantou BadRequestException inesperadamente!")
    ...
    def test_change_state_auto_mode_valid_transition(self):
        ...
        with patch.object(self.service, '_get_valid_event_from_state', return_value=event) as mock_get_event:
    ...
    def test_change_state_auto_mode_invalid_transition(self):
        ...
        with patch.object(self.service, '_get_valid_event_from_state', side_effect=IllegalStateException("invalid_state_transition")):
            with self.assertRaises(IllegalStateException) as context:
                self.service.change_state(identifier=identifier, new_state=new_state)
    ...
    def test_delete_auto_mode_success(self):
        ...
        self.mock_gateway.delete.assert_called_once_with(repository=existing_doi.prefix, identifier=existing_doi.suffix)
        self.mock_repository.delete.assert_called_once_with(doi=existing_doi)
