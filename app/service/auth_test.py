...
class TestAuthService(unittest.TestCase):
    ...
    def test_validate_jwt_and_decode_success_with_real_token(self):
        
        user_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..h6RazdRo5qJ4hHuWO_z37IKoBfQh3Y_Yui2OG-NSFfY"

        result = self.auth_service.validate_jwt_and_decode(user_token)

        self.assertEqual(result, {
            # fixed audience generated for JWT file upload auth JWT token
            'aud': 'file_upload',
            # expire date, usually 1d
            'exp': 1717540398,
            # fileID generated by the frontend with uppy
            'file': 'uppy-localhost/3000//png-2v-2v-1e-image/png-1669504-1708001462249', 
            # issued at
            'iat': 1717453998,
            # issuer name
            'iss': 'datamap_bff',
            # userID from datamap
            'sub': 'd53a181d-efe8-4aa1-a3dc-ceb94aa67043'
        })
