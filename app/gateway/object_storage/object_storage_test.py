...
class TestObjectStorageGateway(unittest.TestCase):
    ...
    def test_put_file_default_content_type(self):
        ...
        self.gateway.put_file(
            bucket_name=bucket, object_name=obj_name, file_data=file_data
        )
    ...
    def test_get_file_success(self):
        ...
        result = self.gateway.get_file(bucket_name=bucket, object_name=obj_name)

        self.mock_minio_client.get_object.assert_called_once_with(
            bucket_name=bucket, object_name=obj_name
        )
    ...
    def test_get_file_not_found(self):
        ...
        with self.assertRaises(FileNotFoundError) as context:
            self.gateway.get_file(bucket_name=bucket, object_name=obj_name)
