...
class TestUserGetEndpoints:
    ...
    def test_get_user_by_provider_reference_success(self, http_client, valid_headers):
        ...
        response = http_client.get("/users/providers/orcid/123456", headers=valid_headers)
        
        # Assert - This will likely return 404 or 500, but we're testing the endpoint exists
        assert response.status_code in [200, 404, 500]
    
    def test_get_user_by_provider_reference_unauthorized_401(self, http_client, no_auth_headers):
        """Test getting user by provider reference without authentication returns 401."""
        # Act
        response = http_client.get("/users/providers/orcid/123456", headers=no_auth_headers)
    ...
    def test_get_users_with_email_filter(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.get("/users/?email=test@example.com", headers=valid_headers)
...
class TestUserCRUDOperations:
    ...
    def test_update_user_success(self, http_client, valid_headers):
        ...
        create_response = http_client.post("/users/", json=create_data, headers=valid_headers)
    ...
    def test_update_user_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.put(f"/users/{non_existent_id}", json=update_data, headers=valid_headers)
    ...
    def test_update_user_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.put(f"/users/{user_id}", json=update_data, headers=no_auth_headers)
    ...
    def test_delete_user_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{non_existent_id}", headers=valid_headers)
    ...
    def test_enable_user_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.put(f"/users/{non_existent_id}/enable", headers=valid_headers)
...
class TestUserRoleOperations:
    ...
    def test_add_roles_success(self, http_client, valid_headers):
        ...
        # Act
        roles = ["admin", "user"]
        response = http_client.put(f"/users/{user_id}/roles", json=roles, headers=valid_headers)
    ...
    def test_add_roles_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.put(f"/users/{non_existent_id}/roles", json=roles, headers=valid_headers)
    ...
    def test_add_roles_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.put(f"/users/{user_id}/roles", json=roles, headers=no_auth_headers)
    ...
    def test_remove_roles_success(self, http_client, valid_headers):
        ...
        response = http_client.delete(f"/users/{user_id}/roles", json=roles_to_remove, headers=valid_headers)
    ...
    def test_remove_roles_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{non_existent_id}/roles", json=roles, headers=valid_headers)
    ...
    def test_remove_roles_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{user_id}/roles", json=roles, headers=no_auth_headers)
...
class TestUserProviderOperations:
    ...
    def test_add_provider_success(self, http_client, valid_headers):
        ...
        response = http_client.put(f"/users/{user_id}/providers", json=provider_data, headers=valid_headers)
    ...
    def test_add_provider_not_found_500(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.put(f"/users/{non_existent_id}/providers", json=provider_data, headers=valid_headers)
    ...
    def test_add_provider_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.put(f"/users/{user_id}/providers", json=provider_data, headers=no_auth_headers)
    ...
    def test_remove_provider_success(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{user_id}/providers?provider=orcid&reference=123456789", headers=valid_headers)
    ...
    def test_remove_provider_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{non_existent_id}/providers?provider=orcid&reference=123456789", headers=valid_headers)
    ...
    def test_remove_provider_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{user_id}/providers?provider=orcid&reference=123456789", headers=no_auth_headers)
...
class TestUserTenancyOperations:
    ...
    def test_add_tenancies_success(self, http_client, valid_headers):
        ...
        response = http_client.post(f"/users/{user_id}/tenancies", json=tenancy_data, headers=valid_headers)
    ...
    def test_add_tenancies_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post(f"/users/{non_existent_id}/tenancies", json=tenancy_data, headers=valid_headers)
    ...
    def test_add_tenancies_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.post(f"/users/{user_id}/tenancies", json=tenancy_data, headers=no_auth_headers)
    ...
    def test_remove_tenancies_success(self, http_client, valid_headers):
        ...
        add_response = http_client.post(f"/users/{user_id}/tenancies", json=tenancy_data, headers=valid_headers)
        assert_status_code(add_response, 200)
        
        # Act - Remove tenancy
        response = http_client.delete(f"/users/{user_id}/tenancies", json=tenancy_data, headers=valid_headers)
    ...
    def test_remove_tenancies_not_found_500(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{non_existent_id}/tenancies", json=tenancy_data, headers=valid_headers)
    ...
    def test_remove_tenancies_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.delete(f"/users/{user_id}/tenancies", json=tenancy_data, headers=no_auth_headers)
...
class TestUserEnforceOperations:
    ...
    def test_enforce_authorization_success(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post(f"/users/{user_id}/enforce", json=enforce_data, headers=valid_headers)
    ...
    def test_enforce_authorization_not_found_500(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post(f"/users/{non_existent_id}/enforce", json=enforce_data, headers=valid_headers)
    ...
    def test_enforce_authorization_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.post(f"/users/{user_id}/enforce", json=enforce_data, headers=no_auth_headers)
    ...
    def test_force_policy_reload_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.post("/users/force-policy-reload", headers=no_auth_headers)
...
class TestUserWorkflow:
    ...
    def test_user_full_lifecycle(self, http_client, valid_headers):
        ...
        # 4. Add roles
        roles = ["admin", "user"]
        roles_response = http_client.put(f"/users/{user_id}/roles", json=roles, headers=valid_headers)
        ...
        provider_response = http_client.put(f"/users/{user_id}/providers", json=provider_data, headers=valid_headers)
        ...
        tenancy_response = http_client.post(f"/users/{user_id}/tenancies", json=tenancy_data, headers=valid_headers)
        ...
        enforce_response = http_client.post(f"/users/{user_id}/enforce", json=enforce_data, headers=valid_headers)
        ...
        # 8. Disable user
        disable_response = http_client.delete(f"/users/{user_id}", headers=valid_headers)
        assert_status_code(disable_response, 200)
        
        # 9. Try to get disabled user (should not find it with default is_enabled=true)
        get_disabled_response = http_client.get(f"/users/{user_id}", headers=valid_headers)
        assert_status_code(get_disabled_response, 404)
        
        # 10. Enable user
        enable_response = http_client.put(f"/users/{user_id}/enable", headers=valid_headers)
