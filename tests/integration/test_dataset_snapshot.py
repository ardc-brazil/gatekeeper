...
class TestDatasetSnapshotEndpoints:
    ...
    def test_get_latest_snapshot_404(self, http_client, no_auth_headers, dataset_fixture):
    ...
    def test_get_latest_snapshot_422(self, http_client, no_auth_headers, dataset_fixture):
    ...
    def test_get_version_snapshot_404(self, http_client, no_auth_headers, dataset_fixture):
    ...
    def test_get_version_snapshot_with_created_dataset_404(self, http_client, no_auth_headers, dataset_fixture):
    ...
    def test_get_version_snapshot_422(self, http_client, no_auth_headers, dataset_fixture):
        ...
        # Act
        response = http_client.get(
            f"/datasets/{invalid_id}/versions/v1.0/snapshot",
            headers=no_auth_headers
        )
    ...
    def test_endpoints_are_public(self, http_client, dataset_fixture):
        ...
        version_response = http_client.get(f"/datasets/{nonexistent_id}/versions/v1.0/snapshot")
    ...
    def test_error_consistency_across_endpoints(self, http_client, no_auth_headers, dataset_fixture):
...
class TestDatasetSnapshotSuccess:
    ...
    @pytest.mark.skip(reason="Requires published dataset with snapshot - implement when DOI workflow works")
    def test_get_latest_snapshot_success_exact_response(self, http_client, no_auth_headers, dataset_fixture):
