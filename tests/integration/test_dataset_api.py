...
class TestDatasetBasicCRUD:
    ...
    def test_create_dataset_success_201(self, http_client, valid_headers):
        ...
        response = http_client.post(
            "/datasets", json=dataset_data, headers=valid_headers
        )
    ...
    def test_create_dataset_invalid_data_422(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post(
            "/datasets", json=invalid_data, headers=valid_headers
        )
    ...
    def test_get_datasets_success_200(
    ...
    def test_get_datasets_with_filters_success_200(
        self, http_client, valid_headers, dataset_fixture
    ):
        ...
        for filter_param in filters:
            response = http_client.get(
                f"/datasets{filter_param}", headers=valid_headers
            )
            assert_status_code(response, 200)
            data = assert_json_response(response)
            assert "content" in data
    ...
    def test_get_dataset_by_id_success_200(
        self, http_client, valid_headers, dataset_fixture
    ):
    ...
    def test_get_dataset_by_id_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.get(
            f"/datasets/{non_existent_id}", headers=valid_headers
        )
    ...
    def test_update_dataset_success_200(
        self, http_client, valid_headers, dataset_fixture
    ):
        ...
        response = http_client.put(
            f"/datasets/{dataset_id}", json=update_data, headers=valid_headers
        )
    ...
    def test_update_dataset_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.put(
            f"/datasets/{non_existent_id}", json=update_data, headers=valid_headers
        )
    ...
    def test_delete_dataset_success_200(
        self, http_client, valid_headers, dataset_fixture
    ):
        ...
        assert_status_code(
            get_response, 404
        )  # Should not be found with default is_enabled=true
    ...
    def test_enable_dataset_success_200(
        self, http_client, valid_headers, dataset_fixture
    ):
        ...
        disable_response = http_client.delete(
            f"/datasets/{dataset_id}", headers=valid_headers
        )
        assert_status_code(disable_response, 200)

        # Act - Enable the dataset
        response = http_client.put(
            f"/datasets/{dataset_id}/enable", headers=valid_headers
        )
    ...
    def test_enable_dataset_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.put(
            f"/datasets/{non_existent_id}/enable", headers=valid_headers
        )
