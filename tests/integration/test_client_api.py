...
class TestClientCRUDOperations:
    ...
    def test_create_client_success_201(self, http_client, valid_headers):
        ...
        # Arrange
        client_data = {"name": "Test Client", "secret": "test-secret-123"}
    ...
    def test_create_client_invalid_data_422(self, http_client, valid_headers):
        ...
        response = http_client.post(
            "/clients", json=invalid_data, headers=valid_headers
        )
    ...
    def test_create_client_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.post(
            "/clients", json=client_data, headers=no_auth_headers
        )
    ...
    def test_update_client_not_found_404(self, http_client, valid_headers):
        ...
        response = http_client.put(
            f"/clients/{nonexistent_key}", json=update_data, headers=valid_headers
        )
    ...
    def test_update_client_invalid_uuid_422(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.put(
            f"/clients/{invalid_uuid}", json=update_data, headers=valid_headers
        )
    ...
    def test_update_client_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.put(
            f"/clients/{some_key}", json=update_data, headers=no_auth_headers
        )
    ...
    def test_delete_client_not_found_404(self, http_client, valid_headers):
        ...
        response = http_client.delete(
            f"/clients/{nonexistent_key}", headers=valid_headers
        )
    ...
    def test_enable_client_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post(
            f"/clients/{nonexistent_key}/enable", headers=valid_headers
        )
    ...
    def test_enable_client_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.post(
            f"/clients/{some_key}/enable", headers=no_auth_headers
        )
...
class TestClientWorkflow:
    ...
    def test_client_crud_workflow(self, http_client, valid_headers):
        ...
        client_data = {"name": "Workflow Test Client", "secret": "workflow-secret-123"}
        create_response = http_client.post(
            "/clients", json=client_data, headers=valid_headers
        )
        ...
        get_deleted_response = http_client.get(
            f"/clients/{client_key}", headers=valid_headers
        )
        ...
        enable_response = http_client.post(
            f"/clients/{client_key}/enable", headers=valid_headers
        )
