...
class TestTenancyGetEndpoints:
    ...
    def test_get_tenancy_by_name_success(self, http_client, valid_headers):
        ...
        response = http_client.get("/tenancies/datamap/production/data-amazon", headers=valid_headers)
        
        # Assert
        assert_status_code(response, 200)
        assert_response_contains_fields(response, {
            "name": "datamap/production/data-amazon",
            "is_enabled": True
        })
    ...
    def test_get_tenancy_by_name_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.get("/tenancies/nonexistent/tenancy", headers=valid_headers)
    ...
    def test_get_tenancy_by_name_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.get("/tenancies/datamap/production/data-amazon", headers=no_auth_headers)
    ...
    def test_get_tenancy_with_is_enabled_param(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.get("/tenancies/datamap/production/data-amazon?is_enabled=true", headers=valid_headers)
...
class TestTenancyCRUDOperations:
    ...
    def test_create_tenancy_success_201(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post("/tenancies/", json=tenancy_data, headers=valid_headers)
    ...
    def test_create_tenancy_invalid_data_422(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post("/tenancies/", json=invalid_data, headers=valid_headers)
    ...
    def test_create_tenancy_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Arrange
        tenancy_data = {
            "name": "test/unauthorized/creation",
            "is_enabled": True
        }
        
        # Act
        response = http_client.post("/tenancies/", json=tenancy_data, headers=no_auth_headers)
    ...
    def test_update_tenancy_success(self, http_client, valid_headers):
        ...
        create_response = http_client.post("/tenancies/", json=create_data, headers=valid_headers)
        ...
        # Act
        response = http_client.put(f"/tenancies/{unique_name}", json=update_data, headers=valid_headers)
    ...
    def test_update_tenancy_not_found_404(self, http_client, valid_headers):
        ...
        # Arrange
        update_data = {
            "name": "test/tenancy/notfound",
            "is_enabled": False
        }
        
        # Act
        response = http_client.put("/tenancies/nonexistent/tenancy", json=update_data, headers=valid_headers)
    ...
    def test_update_tenancy_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Arrange
        update_data = {
            "name": "test/tenancy/unauthorized",
            "is_enabled": False
        }
        
        # Act
        response = http_client.put("/tenancies/datamap/production/data-amazon", json=update_data, headers=no_auth_headers)
    ...
    def test_delete_tenancy_success_204(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.delete(f"/tenancies/{unique_name}", headers=valid_headers)
    ...
    def test_delete_tenancy_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.delete("/tenancies/nonexistent/tenancy", headers=valid_headers)
    ...
    def test_delete_tenancy_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.delete("/tenancies/datamap/production/data-amazon", headers=no_auth_headers)
    ...
    def test_enable_tenancy_success(self, http_client, valid_headers):
        ...
        # Disable it
        delete_response = http_client.delete(f"/tenancies/{unique_name}", headers=valid_headers)
        assert_status_code(delete_response, 204)
        
        # Act - Enable it
        response = http_client.post(f"/tenancies/{unique_name}/enable", headers=valid_headers)
    ...
    def test_enable_tenancy_not_found_404(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post("/tenancies/nonexistent/tenancy/enable", headers=valid_headers)
    ...
    def test_enable_tenancy_unauthorized_401(self, http_client, no_auth_headers):
        ...
        # Act
        response = http_client.post("/tenancies/datamap/production/data-amazon/enable", headers=no_auth_headers)
...
class TestTenancyPathHandling:
    ...
    def test_tenancy_path_with_multiple_slashes(self, http_client, valid_headers):
        ...
        # Act - Create
        create_response = http_client.post("/tenancies/", json=tenancy_data, headers=valid_headers)
        assert_status_code(create_response, 201)
...
class TestTenancyWorkflow:
    ...
    def test_tenancy_full_lifecycle(self, http_client, valid_headers):
        ...
        get_response = http_client.get(f"/tenancies/{tenancy_name}", headers=valid_headers)
        ...
        update_response = http_client.put(f"/tenancies/{tenancy_name}", json=update_data, headers=valid_headers)
        assert_status_code(update_response, 200)
        
        # 4. Get updated tenancy
        get_updated_response = http_client.get(f"/tenancies/{updated_name}", headers=valid_headers)
        ...
        # 5. Disable tenancy
        disable_response = http_client.delete(f"/tenancies/{updated_name}", headers=valid_headers)
        assert_status_code(disable_response, 204)
        
        # 6. Try to get disabled tenancy (should not find it with default is_enabled=true)
        get_disabled_response = http_client.get(f"/tenancies/{updated_name}", headers=valid_headers)
        assert_status_code(get_disabled_response, 404)
        
        # 7. Enable tenancy
        enable_response = http_client.post(f"/tenancies/{updated_name}/enable", headers=valid_headers)
        assert_status_code(enable_response, 200)
        
        # 8. Get re-enabled tenancy
        get_reenabled_response = http_client.get(f"/tenancies/{updated_name}", headers=valid_headers)
