...
class TestTusHooksEndpoint:
    ...
    def test_post_finish_hook_success_200(self, http_client, valid_headers, dataset_fixture):
    ...
    def test_post_finish_hook_invalid_user_token_200(self, http_client, valid_headers, dataset_fixture):
    ...
    def test_post_finish_hook_missing_user_id_500(self, http_client, valid_headers, dataset_fixture):
        ...
        payload = {
            ...
            "Event": {
                ...
                "HTTPRequest": {
                    "Header": {
                        "X-User-Token": [create_tus_jwt_token("cbb0a683-630f-4b86-8b45-91b90a6fce1c")]
                        # Missing X-User-Id
                    }
                }
            }
    ...
    def test_post_finish_hook_missing_user_token_500(self, http_client, valid_headers, dataset_fixture):
    ...
    def test_post_finish_hook_different_file_types(self, http_client, valid_headers, dataset_fixture):
    ...
    def test_post_finish_hook_large_file(self, http_client, valid_headers, dataset_fixture):
    ...
    def test_post_finish_hook_special_characters_filename(self, http_client, valid_headers, dataset_fixture):
...
class TestTusErrorScenarios:
    ...
    def test_post_finish_hook_invalid_json_422(self, http_client, valid_headers):
        ...
        # Act
        response = http_client.post("/tus/hooks", 
                                  data="invalid json", 
    ...
    def test_post_finish_hook_missing_type_field_500(self, http_client, valid_headers, dataset_fixture):
    ...
    def test_post_finish_hook_missing_event_field_500(self, http_client, valid_headers, dataset_fixture):
